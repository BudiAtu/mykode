						...
						echo "<a href='$ia[url]' target='_blank'>";
							...
							if ($ia['gambar'] != ''){
								if(preg_match("/swf\z/i", $string)) {
									echo "<embed style='margin-top:-10px; height:200px; width:100%'' src='".base_url()."asset/foto_iklantengah/$ia[gambar]'  quality='high' type='application/x-shockwave-flash'>";
								} else {
									echo "<img style='margin-top:-10px; margin-bottom:5px; height:200px; width:100%' src='".base_url()."asset/foto_iklantengah/$ia[gambar]' title='$ia[judul]' />";
								}
							}
						echo "</a>";
						?>
