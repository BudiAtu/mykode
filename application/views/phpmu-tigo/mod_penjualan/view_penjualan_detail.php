                    ...
                    <tr><th scope='row'>Status</th>                        <td>
                      <?php
                        if ($rows['proses']=='0'){ 
                          ...
                          $proses = '<i class="text-success">Proses</i>'; $status = 'Dikirim'; $icon = 'star text-yellow'; $ubah = 3; 
                      }elseif($rows['proses']=='3'){ 
                          $proses = '<i class="text-success">Dikirim</i>'; $status = 'Diterima'; $icon = 'star text-yellow'; $ubah = 4; 
                      }elseif($rows['proses']=='4'){ 
                        $proses = '<i class="text-success">Diterima</i>'; $status = 'Selesai'; $icon = 'star text-yellow'; $ubah = 5; 
                      }elseif($rows['proses']=='5'){ 
                        $proses = '<i class="text-success">Selesai</i>'; $status = 'Konfirmasi'; $icon = 'star text-yellow'; $ubah = 0; 
                      }else{ 
                          $proses = '<i class="text-info">Konfirmasi</i>'; $status = 'Selesai'; $icon = 'star'; $ubah = 1; 
                      } 
