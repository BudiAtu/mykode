...
<div class="widget">
	<?php
	  $pasangiklan3 = $this->model_utama->view_ordering_limit('pasangiklan','id_pasangiklan','ASC',2,1);
	  foreach ($pasangiklan3->result_array() as $b) {
		$string = $b['gambar'];
		if ($b['gambar'] != ''){
			if(preg_match("/swf\z/i", $string)) {
				echo "<embed src='".base_url()."asset/foto_pasangiklan/$b[gambar]' width=300 height=240 quality='high' type='application/x-shockwave-flash'>";
		...
		<?php						  
		  ...
		  echo "<div class='gallery-widget'>
					...
					<div class='gallery-content'>
						...
						<span class='meta'>
							<span class='right'>$d[hari], $tgl - Dilihat $d[dilihat] Kali</span>
