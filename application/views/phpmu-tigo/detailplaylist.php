											  ...
											  foreach ($detailplaylist->result_array() as $r) {	
												  ...
												  echo "<div class='article-big'>
															...
															if (preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $r['youtube'], $match)) {
																...
																echo "	<video width='210' height='150' controls>
																<source src='".base_url()."asset/files/movie.mp4' type='video/mp4'>
																</video>";
														...
														echo "</div>
															<div class='article-content'>
																...
																<span class='meta'>
																	...
																	<a href='".base_url()."playlist/watch/$r[video_seo]'><span class='icon-text'>&#128340;</span>$r[jam], ".tgl_indo($r['tanggal']).", $r[dilihat] View</a>
																</span>
																<p>$isi . . .</p>
																<span class='meta'>
