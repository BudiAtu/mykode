					...
					<div class="shortcode-content">
							<div class="column12">
								...
								<form action="<?php echo base_url(); ?>kontributor/pendaftaran" method="POST" enctype='multipart/form-data' onSubmit="return validasireg(this)">
									...
									<p><br><input type="submit" class="styled-button" name='submit' value="Daftar Sekarang!" /> <a class='btn btn-xs btn-success' style='width:60px' href='administrator/login_kontributor'>Login</a> </p>
