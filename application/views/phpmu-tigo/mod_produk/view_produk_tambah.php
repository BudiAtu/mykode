    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Url Demo</th>                     <td><input type='text' class='form-control' name='c'></td></tr>
                    <tr><th scope='row'>Sorcode Url</th>                      <td><input type='text' class='form-control' name='berat'></td></tr>
