													...
													foreach ($album->result_array() as $h) {	
														...
														<div style='height:150px; overflow:hidden;'>
																	<a href='".base_url()."albums/detail/$h[album_seo]' class='hover-effect'>";
																		if ($h['gbr_album'] ==''){
																			echo "<a class='hover-effect' href='".base_url()."albums/detail/$h[album_seo]'><imgs tyle=' min-height:140px; width:100%' src='".base_url()."asset/img_album/no-image.jpg' alt='no-image.jpg' /></a>";
																		}else{
																			echo "<a class='hover-effect' href='".base_url()."albums/detail/$h[album_seo]'><img style=' min-height:140px; width:100%' src='".base_url()."asset/img_album/$h[gbr_album]' alt='$h[gbr_album]' /></a>";
																		}
																echo "</a>
																</div>
