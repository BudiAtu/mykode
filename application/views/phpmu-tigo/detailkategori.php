...
<div class="content-block main left">
	<div class="block">
		<div class="block-title" style="background: #2182b4;">
			...
			<h2>Berita Kategori "<?php echo "$rows[nama_kategori]"; ?>"</h2>
		</div>
		<div class="block-content">
			...
			<?php
			  foreach ($beritakategori->result_array() as $r) {	
				  ...
				  echo "<li>
							<div style='height:160px; background:#e3e3e3; overflow:hidden; margin-right:10px' class='article-photo hidden-xs'>
								<a href='".base_url()."$r[judul_seo]' class='hover-effect'>";
									if ($r['gambar'] == ''){
										...
										echo "<img style='width:210px;height:160px' src='".base_url()."asset/foto_berita/$r[gambar]' alt='$r[gambar]' /></a>";
									}
								echo "</a>
							</div>
							<div class='article-photo visible-xs' style='float:left; margin-right:5px'>";
								if ($r['gambar'] ==''){
									...
									echo "<a class='hover-effect' href='".base_url()."$r[judul_seo].html'><img style='width:160px; height:100px' src='".base_url()."asset/foto_berita/$r[gambar]' alt='$r[gambar]' /></a>";
								}
						echo "</div>

							<div class='article-content'>
								<h2 class='hidden-xs h2-judul'><a title='$r[judul]' href='".base_url()."$r[judul_seo]'>$judul</a></h2>
								<span class='meta visible-xs' style='font-style:italic;'>
									<a style='font-size:11px' href='".base_url()."$r[judul_seo]'><span class='icon-text'>&#128340;</span> $r[jam], ".tgl_indo($r['tanggal'])."</a>
								</span>
								<h6 class='visible-xs'><a title='$r[judul]' href='".base_url()."$r[judul_seo]'>$judul</a></h6>
