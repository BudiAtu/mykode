...
echo "<div class='wrapper'>			
	...
	<div class='header-addons'>
		<span class='city'>
          ...
          if ($this->session->id_konsumen != ''){
          	$isi_keranjang = $this->db->query("SELECT * FROM rb_penjualan_detail where id_penjualan='".$this->session->idp."'")->row_array();
            echo "<a href='".base_url()."members/orders_report'>Status Transaksi</a> &nbsp; &nbsp; 
            	  ...
            	  <a class='btn btn-xs btn-success' style='padding:1px 12px' href='".base_url()."members/profile'>Haloo! $ksm[nama_lengkap]</a> 
            ...
            echo "<a class='btn btn-xs btn-success' style='width:60px' href='".base_url()."auth/login'>Login</a> 
				  <a class='btn btn-xs btn-default' style='width:60px; color:#000' href='".base_url()."auth/register'>Daftar</a><hr>";
