<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->uri->segment(1).'/edit_banner_produk',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$rows[id_banner_produk]'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->uri->segment(1)."/banner_produk'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
