          ...
          <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <?php 
                    ...
                    $cek=$this->model_app->umenu_akses("konsumen",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/pembayaran_konsumen'><i class='fa fa-circle-o'></i> Pembelian Konsumen</a></li>";
                    }
                    ...
                    $cek=$this->model_app->umenu_akses("rekening_reseller",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/rekening_reseller'><i class='fa fa-circle-o'></i> Rekening Reseller</a></li>";
                    }
            ...
            <li class="treeview">
              ...
              <?php
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/album'><i class='fa fa-circle-o'></i> Album Foto</a></li>";
                }
            ...
            <li class="treeview">
              ...
              <?php
                ...
                $cek=$this->model_app->umenu_akses("banner_produk",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/banner_produk'><i class='fa fa-circle-o'></i> Kategori Produk</a></li>";
                }
