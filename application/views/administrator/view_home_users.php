<?php
    ...
    echo "<div class='col-md-6'>
        ...
        $feedlist = new rss('https://gilakodingan.web.app/tutorial.html'); /* Ubah link feed disini dengan link feed Anda */
        /*echo $feedlist->display(5,"tutorial.html"); /* Angka 7 digunakan untuk menampilkan jumlah artikel */
   /* echo "</section>";*/