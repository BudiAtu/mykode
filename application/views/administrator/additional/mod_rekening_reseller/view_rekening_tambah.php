<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/tambah_rekening_reseller',$attributes); 
          echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='rekening'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
